...
public class AdminAlumni implements ActionListener{
	...
	public AdminAlumni() {
		...
		label=new JLabel("Select an operation for the Admin:");
		Font font=new Font("Serif", Font.ITALIC, 34);
		label.setFont(font);
		label.setBounds(400,50,520,70);
		
		viewall=new JButton("View all Alumni");
		viewall.setBounds(500,150,300,30);
		viewall.addActionListener(this);
		
		viewone=new JButton("Search Alumni based on specific attributes");
		viewone.setBounds(500,190,300,30);
		viewone.addActionListener(this);
		
		delete=new JButton("Delete Particular Alumni");
		delete.setBounds(500,230,300,30);
