...
//			ResultSet rs=stmt.executeQuery("select * from base where "+((year!="-----select-----")?"year_of_pass= '"+year+"'"+((worksin!="-----select-----" && wname!="")?(" and works= '"+worksin+"'"+
//					((worklocation!="-----select-----")?" and work_loc= '"+worklocation+"'":"")):
//				((worklocation!="-----select-----")?" and work_loc= '"+worklocation+"'":"")):
...
//					((worklocation!="-----select-----")?(year!="-----select-----" || (worksin!="-----select-----" && wname!=""))?" and worklocation= '"+worklocation+"'":"worklocation= '"+worklocation+"'":"year='2012'"))));
			...
			ResultSet rs = stmt.executeQuery("select * from base where year_of_pass = '" + year +"'and works ='"+worksin + "'and work_loc = '" + worklocation + "';");
			while(rs.next())
			{
				count++;
			}
...
//					((worksin!="-----select-----" && wname!="")?"worksin= '"+worksin+"' and wname='"+wname+"'"+((worklocation!="-----select-----")?" and worklocation= '"+worklocation+"'":""):
//						((worklocation!="-----select-----")?(year!="-----select-----" || (worksin!="-----select-----" && wname!=""))?" and worklocation= '"+worklocation+"'":"worklocation= '"+worklocation+"'":"year='2012'"))));
				ResultSet rs1 = stmt.executeQuery("select * from base where year_of_pass = '" + year +"'and works ='"+worksin + "'and work_loc = '" + worklocation + "';");
